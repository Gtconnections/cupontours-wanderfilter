    ...
    <main className="event-page">
          ...
          <div className="event-grid">
            {isLoading ? (
              ...
              <div className="empty-state">
                <p>No upcoming events available at the moment. Please check back later.</p>
              </div>
            ) : (
                ...
                <div key={item.id} className="event-card">
                  ...
                  <div className="event-info">
                    ...
                    <div className="event-capacity">
                      ...
                      Limited to {item.capacity} guests
                    </div>
                    
                    <div className="event-footer">
                      <span className="event-price">
                        {parseFloat(item.price) === 0 ? 'Free Entry' : `$${parseFloat(item.price).toFixed(2)}`} 
                        {parseFloat(item.price) > 0 && <span className="price-unit">/ Ticket</span>}
                      </span>
      ...
      <section className="event-cta">
        <div className="cta-container">
          <h2>Host Your Own Private Event?</h2>
          <p>Our expert planners can organize exclusive gatherings, from intimate dinners with Michelin-starred chefs to grand corporate celebrations.</p>
          <div className="cta-actions">
            <Link href="/contact" className="btn-outline-pill">Contact Event Concierge</Link>
          </div>
        </div>
      </section>
    </main>
