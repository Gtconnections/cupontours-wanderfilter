  ...
  const handleRecoverSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (response.ok) {
        setFeedback({
          type: 'success',
          text: "We've sent a temporary password to your email. Please check your inbox (and your spam folder), then sign in and change it.",
        });
        setEmail('');
      } else {
        // El backend responde { error: "..." } (400 email inexistente, 401 cuenta bloqueada, etc.)
    ...
    <main className="recover-split-page recover-page">
        ...
        <div className="recover-box-container">
          <div className="recover-header-text">
            ...
            <p className="recover-subtitle">
              We understand, these things happen. Please enter your registered email address below, and we will immediately send you a temporary password so you can sign back in and regain access to your dashboard.
            </p>
          </div>
      ...
      <section className="recover-image-side">
        ...
        <div className="image-side-caption">
          <p className="caption-tagline">&ldquo;Security meets sanctuary.&rdquo;</p>
