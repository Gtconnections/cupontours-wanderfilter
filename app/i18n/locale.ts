...
export const ES_ROUTES = new Set<string>(["/", "/properties", "/cars", "/yachts", "/jets", "/invest-with-us", "/services", "/contact", "/services/events", "/services/experiences", "/services/general", "/services/health", "/services/real-estate", "/services/transport", "/services/wellness", "/about-us", "/work-with-us", "/terms", "/privacy", "/login", "/recover-account"]);
