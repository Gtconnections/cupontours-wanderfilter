// components/DeleteYachtImageConfirmModal.tsx
'use client';

import React from 'react';
import { FiX, FiAlertTriangle } from 'react-icons/fi';

interface DeleteYachtImageConfirmModalProps {
  isOpen: boolean;
  imageId: number;
  onClose: () => void;
...
export default function DeleteYachtImageConfirmModal({
  isOpen,
  imageId,
  onClose,
  onConfirm,
  isLoading
}: DeleteYachtImageConfirmModalProps) {
