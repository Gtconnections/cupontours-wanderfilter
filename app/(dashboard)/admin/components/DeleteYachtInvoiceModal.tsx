// components/DeleteYachtInvoiceModal.tsx
'use client';

import React, { useState } from 'react';
import { FiX, FiAlertTriangle } from 'react-icons/fi';

interface DeleteYachtInvoiceModalProps {
  isOpen: boolean;
  onClose: () => void;
...
export default function DeleteYachtInvoiceModal({
  isOpen,
  onClose,
  onConfirm,
  isLoading,
