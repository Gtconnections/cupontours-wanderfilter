// app/(dashboard)/admin/components/ModalEditWellness.tsx

'use client';

import React, { useState, useEffect } from 'react';
import { FiX, FiSave } from 'react-icons/fi';
import { updateWellnessService, Wellness } from '@/app/lib/api/wellnessAdmin';
import './ModalEditService.css';

interface ModalEditWellnessProps {
  isOpen: boolean;
  onClose: () => void;
  onSuccess: () => void;
  item: Wellness;
...
export default function ModalEditWellness({ isOpen, onClose, onSuccess, item }: ModalEditWellnessProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      await updateWellnessService(item.id, {
        name: formData.name,
      ...
      console.error('❌ Error al actualizar servicio de bienestar:', err);
