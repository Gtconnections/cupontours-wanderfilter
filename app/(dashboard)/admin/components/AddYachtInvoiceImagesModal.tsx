// components/AddYachtInvoiceImagesModal.tsx
'use client';

import React, { useState, useRef } from 'react';
import { FiX, FiImage, FiAlertCircle } from 'react-icons/fi';

interface AddYachtInvoiceImagesModalProps {
  isOpen: boolean;
  invoiceId: number;
  onClose: () => void;
...
export default function AddYachtInvoiceImagesModal({
  isOpen,
  invoiceId,
  onClose,
  onUpload
}: AddYachtInvoiceImagesModalProps) {
    ...
    <div className="wander-modal-overlay" onClick={handleClose} style={{
      ...
      <div className="wander-modal wander-modal-images" onClick={(e) => e.stopPropagation()} style={{
        ...
        <div className="wander-modal-body" style={{ padding: '24px 28px' }}>
          ...
          >
            <FiImage size={40} color="#999999" style={{ marginBottom: '8px' }} />
