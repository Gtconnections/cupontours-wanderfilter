// app/admin/properties/create-luxury/page.tsx
...
export default function CreateLuxuryPropertyPage() {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      setToastMessage('✅ Luxury property created successfully!');
      ...
      console.error('❌ Error al crear propiedad luxury:', err);
      setError((err instanceof Error ? err.message : undefined) || 'Error al crear la propiedad luxury');
    } finally {
      setIsLoading(false);
    }
  };
        ...
        <div className="wander-create-property-header-content">
          <div>
            <div className="wander-create-property-breadcrumb">
              LISTINGS / LUXURY / CREATE
            </div>
            <h1>Create Luxury Property</h1>
            <p className="wander-create-property-subtitle">
              Fill in the details to create a new luxury property listing
            </p>
          </div>
          <Link 
            href="/admin/properties/luxury"
            ...
            <div className="wander-create-property-grid">
              ...
              <div className="wander-create-property-field">
                ...
                <input
                  ...
                  placeholder="Exclusive Oceanfront Luxury Villa"
              ...
              <div className="wander-create-property-field">
                ...
                <input
                  ...
                  name="listing_name"
                  className="wander-create-property-input"
                  placeholder="Villa de Lujo Calle 8"
            ...
            <div className="wander-create-property-grid">
              ...
              <div className="wander-create-property-field full-width">
                ...
                <textarea
                  ...
                  placeholder="Write a compelling description of your luxury property..."
        ...
        <div className="wander-create-property-navigation">
          ...
          <div className="wander-create-property-navigation-right">
            <button
              ...
              onClick={() => router.push('/admin/properties/luxury')}
              disabled={isLoading}
            >
              Cancel
            </button>
            {currentStep < STEPS.length ? (
              ...
              >
                <FiSave size={18} />
                {isLoading ? 'Creating...' : 'Create Luxury Property'}
              </button>
            )}
          </div>
        </div>
